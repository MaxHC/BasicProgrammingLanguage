...
public interface CalculetteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#loop}.
	 * @param ctx the parse tree
	 */
	void enterLoop(CalculetteParser.LoopContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#loop}.
	 * @param ctx the parse tree
	 */
	void exitLoop(CalculetteParser.LoopContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#function}.
	 * @param ctx the parse tree
	 */
	void enterFunction(CalculetteParser.FunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#function}.
	 * @param ctx the parse tree
	 */
	void exitFunction(CalculetteParser.FunctionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CalculetteParser#namedFunction}.
	 * @param ctx the parse tree
	 */
	void enterNamedFunction(CalculetteParser.NamedFunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link CalculetteParser#namedFunction}.
	 * @param ctx the parse tree
	 */
	void exitNamedFunction(CalculetteParser.NamedFunctionContext ctx);
	/**
