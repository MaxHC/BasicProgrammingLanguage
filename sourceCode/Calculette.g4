...
branchement returns [ String code ] //maybe opti later
	: 'if' '(' condition ')' instruction {
		String labelEnd = getNewLabel();
		$code = $condition.code + "JUMPF " + labelEnd + "\n" + $instruction.code + "LABEL " + labelEnd + "\n";
	}
